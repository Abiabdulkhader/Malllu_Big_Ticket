...
const T = {
  ML: {
    ...
    paidText: (c) =>
      c === 10
        ? "എല്ലാവരും കാശ് തന്നു"
        : c === 1
        ? "ഒരാൾ കാശ് തന്നു"
        : `${c} പേർ കാശ് തന്നു`,
    unpaidText: (c) =>
      c === 0
        ? "ആരും മുങ്ങി നടക്കുന്നില്ല"
        : c === 1
  ...
  EN: {
    ...
    peopleCount: (c) => (c === 10 ? "Everyone Paid" : `${c}/10 People`),
            ...
            <div className="pb-32">
              ...
              <div className="px-6 mb-6">
                ...
                >
                  ...
                  {isGoalReached && (
                    <div
                      className={`mt-5 bg-white/20 backdrop-blur-md border border-white/40 rounded-2xl p-3 flex items-center justify-center gap-2 text-white font-black text-sm shadow-lg ${
